...
class MarkerPredictionVAE:
    ...
    @staticmethod
    def build_multi_encoder_variational_auto_encoder(training_data: pd.DataFrame, validation_data: pd.DataFrame,
                                               input_dimensions: int,
                                               embedding_dimension: int, activation='relu', learning_rate: float = 1e-3,
                                               optimizer: str = "adam", use_ml_flow: bool = True):
        """
        ...
        g1 = layers.Dense(input_dimensions, activation=activation, activity_regularizer=r, name="encoding_g1")(
            encoder_inputs)
        g2 = layers.Dense(input_dimensions / 1.5, activation=activation, activity_regularizer=r, name="encoding_g2")(g1)
        g3 = layers.Dense(input_dimensions / 2, activation=activation, activity_regularizer=r, name="encoding_g3")(g2)
        g4 = layers.Dense(input_dimensions / 2.5, activation=activation, activity_regularizer=r, name="encoding_g4")(g3)
        g5 = layers.Dense(input_dimensions / 3, activation=activation, activity_regularizer=r, name="encoding_g5")(g4)

        combined_input = concatenate([g5, h5], axis=1)
