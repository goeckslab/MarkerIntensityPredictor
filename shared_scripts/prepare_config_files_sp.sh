...
DATA_DIRECTORY=./data/tumor_mesmer_sp_${SPATIAL}
DATA_DIRECTORY_COMBINED=./data/tumor_mesmer_sp_${SPATIAL}/combined
DATA_DIRECTORY_COMBINED_PREPROCESSED=./data/tumor_mesmer_sp_${SPATIAL}/combined/preprocessed
DATA_DIRECTORY_PREPROCESSED=./data/tumor_mesmer_sp_${SPATIAL}/preprocessed
